...
- `project_contacts`: `id`, `project_id`, `name`, `email`, `avatar_url`, `created_at`, `updated_at` — people without login accounts who can be assigned as owners
- `meetings`: `id`, `project_id`, `transcript_text`, `category`, `status` (Draft|Processing|Review|Published|Failed), `created_at`, `processed_at`
- `action_items`: `id`, `project_id`, `title`, `description`, `status`, `owner_user_id`, `owner_contact_id`, `due_date`, `embedding` (vector), `source_meeting_id`, `created_at`, `updated_at`
- `decisions`: `id`, `project_id`, `title`, `rationale`, `impact`, `decision_maker_user_id`, `decision_maker_contact_id`, `outcome`, `embedding` (vector), `source_meeting_id`, `created_at`, `updated_at`
- `risks`: `id`, `project_id`, `title`, `description`, `probability`, `impact`, `mitigation`, `status`, `owner_user_id`, `owner_contact_id`, `embedding` (vector), `source_meeting_id`, `created_at`, `updated_at`
